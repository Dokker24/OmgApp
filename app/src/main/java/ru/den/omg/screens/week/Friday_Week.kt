...
fun Friday_Week(navController: NavController, context: Context) {
    ...
    OmgTheme {
        Scaffold(
            ...
            TopBarWeek(navController = navController, title = stringResource(id = R.string.friday))
            Column(modifier = Modifier.padding(top = 60.dp)) {
                Column {
                    OutlinedTextField(value = fridayViewModel.newText,
                        onValueChange = { item ->
                            fridayViewModel.newText = item
                        ...
                        trailingIcon = {
                            IconButton(
                                onClick = {
                                    if (fridayViewModel.newText != "") fridayViewModel.insertItem()
                                },
                                modifier = Modifier
                                    .padding(10.dp)
                            ) {
                        ...
                        isError = MainViewModel.isNumeric(fridayViewModel.newText)
                    )
                    Card(
                        ...
                        Row {
                            TextField(value = fridayViewModel.newTimeBefore,
                                onValueChange = { fridayViewModel.newTimeBefore = it },
                                colors = TextFieldDefaults.colors(
                            ...
                            TextField(value = fridayViewModel.newTimeAfter,
                                onValueChange = { fridayViewModel.newTimeAfter = it },
                                colors = TextFieldDefaults.colors(
                                    focusedIndicatorColor = Color.Transparent,
                                    unfocusedIndicatorColor = Color.Transparent,
